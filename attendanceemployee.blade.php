                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a href="{{route('form/holidaysemployee/new')}}">Holidays</a></li>
                    ...
                    <li class="submenu"> <a href="#"><i class="la la-user"></i>
                        ...
                        <ul style="display: none;">
                            <li><a href="{{ url('form/employeeprofile') }}"> Employee Profile </a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="card punch-status">
                        <div class="card-body">
                            ...
                            <div class="punch-info">
                                <div class="punch-hours" style="background: #111">
                                    <div class="content">
                            ...
                            <div class="punch-btn-section">
                                <button type="button" class="btn btn-success">Punch In</button>
